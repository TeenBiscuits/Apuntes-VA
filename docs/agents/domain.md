...
hypothesis, or test name, use the term as defined in `CONTEXT.md`. Don't drift
to synonyms the glossary explicitly avoids.

If the concept you need isn't in the glossary yet, that is a signal: either
you're inventing language the project doesn't use, or there is a real gap to
record with `/domain-modeling`.
